...
#define SUNXI_R_CPUCFG_BASE		0x07000400L
#define SUNXI_PRCM_BASE			0x07010000L
#define SUNXI_R_PIO_BASE		0x07022000L
#define SUNXI_R_UART_BASE		0x07080000L
#define SUNXI_R_TWI_BASE		0x07081400L

#define SUNXI_RTWI0_BRG_REG		(SUNXI_PRCM_BASE+0x019c)
